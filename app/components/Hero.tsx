    ...
    <section className="" id="home"> 
        <div className="flex items-center justify-center h-screen px-5">
            <div className="flex flex-col items-center max-w-3xl gap-5">
                ...
                <h2 className="text-lg md:text-2xl text-center tracking-wider leading-normal">I&apos;m Sean, a full stack developer. I can jugle both front-end and back-end, but still working on some fancy tricks. Let&apos;s build something awesome together!</h2>
                <Link href="#contact">
